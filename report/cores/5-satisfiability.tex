...
\centeredcaption{Edited output of the script ``exe-SAT.sh'' using the parameters of the
example in figure \ref{fig:satisfiability:gov-script}.}
\label{fig:satisfiability:gov-script:result}
\end{figure}

The execution, however, requires knowing how to execute the lingeling SAT solver.
