...
\end{minted}
\centeredcaption{Options of the benchmarking script to execute the solver for Constraint
Programming on the inputs in the ``material'' directory.}
...
\end{minted}
\centeredcaption{Example of the progress of the benchmark script for the
