...
\centering
	...
	\end{tabular}
	\centeredcaption{Time in seconds that the framework in figure \ref{fig:satisfiability:framework}
	needed to solve the different instances for the different encodings of the ``at most one'' constraint.
	$\mathcal{Q}$ for the quadratic, $\mathcal{L}$ for the logarithmic, and $\mathcal{H}$ for
	the Heule encoding, as formalised in section \ref{sec:satisfiability}, equations \ref{eq:cnf:at-most-one:quad},
