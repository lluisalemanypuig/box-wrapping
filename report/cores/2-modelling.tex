...
\begin{enumerate}
	...
	\begin{figure}[H]
	    ...
	    \begin{subfigure}{0.45\textwidth}
			...
			{\input{figures/out-of-bounds-no-rot.tex}}
			%\includegraphics[scale=0.125]{out-of-bounds-no-rot}
	    ...
	    \begin{subfigure}{0.45\textwidth}
	        \centering
	        \psscalebox{0.75 0.75}
			{\input{figures/out-of-bounds-rot.tex}}
	    	%\includegraphics[scale=0.125]{out-of-bounds-rot}
